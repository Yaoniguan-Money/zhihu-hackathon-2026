...
| REL0 公网 P0 | IN PROGRESS | Convex Cloud 侧完成：prod 部署 `agile-turtle-860`、functions/schema、AI_*/JWT/JWKS 环境变量、冻结 Golden 案件种子、8 项生产验证全过、生产 build 通过。Vercel Web/API 待用户 `vercel login` 后部署 + 线上冒烟。见 [REL0 handoff](./docs/handoffs/2026-09-05-rel0-convex-cloud.md)。 |
